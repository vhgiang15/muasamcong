...
public class UserExcelExporterArr {
	
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private BidsNoticeDTO[] listDTOarr;
     
    public UserExcelExporterArr(BidsNoticeDTO[] listDTOarr) {
        this.listDTOarr = listDTOarr;
    ...
    private void writeHeaderLine() {
        ...
        createCell(row, 6, "Lĩnh vực", style);
        createCell(row, 7, "Hình thức", style);
        createCell(row, 8, "Giá gói thầu", style);
        createCell(row, 9, "Giá trúng thầu", style);
        createCell(row, 10, "Đơn vị trúng thầu", style);
    ...
    private void writeDataLines() {
        ...
        for (BidsNoticeDTO bidsNoticeDTO : listDTOarr) {
